    ...
    return (
        ...
        <div className="one">
            ...
            <div className="content">
                ...
                <div className="itemm item_last"> <button className="btn btn-outline-success" >Add to cart</button> <button className="btn btn-outline-dark" >Back to Mart</button> </div>
            </div>
